...
class LandscapeViewDesign: UIView {
    ...
    func adjustConstraints() {
        ...
        let emailTextFieldConstraints = [
            emailTextField.centerYAnchor.constraint(equalTo: self.centerYAnchor, constant: -10),
            emailTextField.leadingAnchor.constraint(equalTo: self.safeAreaLayoutGuide.leadingAnchor, constant: 20),
            emailTextField.trailingAnchor.constraint(equalTo: self.centerXAnchor, constant: -10),
            emailTextField.heightAnchor.constraint(equalToConstant: 50),
        ]
        let passwordTextFieldConstraints = [
            passwordTextField.centerYAnchor.constraint(equalTo: emailTextField.centerYAnchor),
            passwordTextField.leadingAnchor.constraint(equalTo: self.centerXAnchor, constant: 10),
